...
<head>
    <title>Stal Reintjes &mdash; Tarieven</title>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
                    ...
                    <div class="col-lg-4">
                        <nav class="site-navigation text-right ml-auto " role="navigation">
                            <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                                ...
                                <li class="active"><a href="services" class="nav-link">Tarieven</a></li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="ftco-blocks-cover-1">
            <div class="ftco-cover-1" style="background-image: url('images/isabel_elvis_rijden.jpg');">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12 text-center">
                            <div class="box-92819">
                                <h1 class="text-uppercase text-black mb-3">Onze Tarieven</h1>
        ...
        <div class="site-section">
            <div class="container">
                <div class="row mb-5 align-items-center">
                    <div class="col-md-7">
                        <h2 class="heading-39291 mb-0">Prijzen</h2>
                    </div>
                </div>
                <div class="row">
                ...
                <img src="fonts/flaticon/svg/fundraise.svg" alt="Image" class="img-fluid">
              </span>
                            <h3 class="mb-4"><a>iets komt hier</a></h3>
