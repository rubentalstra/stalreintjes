...
<head>
    <title>Stal Reintjes &mdash; Blog</title>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
        ...
        <div class="ftco-blocks-cover-1">
            <div class="ftco-cover-1" style="background-image: url('images/isabel-elvis-prijs.jpg');">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12 text-center">
                            <div class="box-92819">
                                <h1 class="text-uppercase text-black mb-3">Blog updates</h1>
                                <p class="mb-0">hier komen leuke updates van de stal</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="site-section">
            <div class="container">
                ...
                <div id="example" class="row align-items-stretch">
