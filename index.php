...
<head>
    <title>Stal Reintjes &mdash; Home</title>
    ...
    <div class="site-wrap" id="home-section">
        ...
        <div class="owl-carousel-wrapper">
            ...
            <div class="owl-carousel owl-1 ">
                <div class="ftco-cover-1" style="background-image: url('images/milou-jade.jpg');"></div>
                <div class="ftco-cover-1" style="background-image: url('images/isabel-elvis.jpg');"></div>
                <div class="ftco-cover-1" style="background-image: url('images/paarden2.jpg');"></div>
            ...
            <div class="container">
                <div class="row  mb-5">
                    <div class="col-md-7">
                        ...
                        <p>hier zijn de laaste paar neiuwe updates van de stal Reintjes</p>
